...
const ICS_URL = process.env.ICS_URL || '// build-calendar.mjs — fetch school ICS → calendar.json (no dependencies)
import { writeFileSync } from 'node:fs';
...
console.log(`Wrote ${out.length} events to calendar.json`);'; // ← 改呢行
